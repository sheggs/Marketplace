...
public class Bid implements Comparable<Bid> {
  ...
  public Bid(User buyer, double bidValue) throws IllegalArgumentException {
    super();
    // Checks if the buyer object is null.
    if ((buyer == null) || (bidValue <= 0)) {
      // Throws an exception with a custom message as the buyer object is null.
      throw new IllegalArgumentException("Your buyer object is null or your bid value is less than or equal to zero!");
    }
    else {
  ...
  public int compareTo(Bid o) throws NullPointerException {
    ...
    if (o == null) {
      ...
      throw new NullPointerException("The comparable object is null. There is a null object inside your ArrayList");
    }
